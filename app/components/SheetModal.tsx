...
const SheetModal: React.FC<SheetModalProps> = ({
  ...
  const modalContent = (
    <AnimatePresence>
      {open && (
        <div
          className="fixed inset-0 z-1000 flex md:items-center items-end justify-center"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          {/* Modal */}
          <motion.div
            className={`relative w-full max-h-[90vh] md:rounded-xl rounded-t-xl overflow-auto no-scrollbar ${className?.container || "max-w-lg"
              }`}
